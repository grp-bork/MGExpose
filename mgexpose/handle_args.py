...
def add_data_args(ap):
    ...
    ap.add_argument("--secretion_data", "--txs_macsy_report", dest="secretion_data", type=str)
    ap.add_argument("--secretion_rules", "--txs_macsy_rules", dest="secretion_rules", type=str)
